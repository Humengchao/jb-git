...
export class SubmoduleTreeProvider implements vscode.TreeDataProvider<SubmoduleRootNode | SubmoduleNode> {
  private readonly changedEmitter = new vscode.EventEmitter<SubmoduleRootNode | SubmoduleNode | undefined | null | void>();
  ...
  public getTreeItem(element: SubmoduleRootNode | SubmoduleNode): vscode.TreeItem {
    return element;
  }

  public async getChildren(element?: SubmoduleRootNode | SubmoduleNode): Promise<(SubmoduleRootNode | SubmoduleNode)[]> {
