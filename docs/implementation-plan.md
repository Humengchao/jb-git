...
2. Model Changelist ownership below the file level so independent or overlapping changes in one file can be separated safely.
3. Add `Hide Revision` to editor-gutter Blame, and issue-tracker links from an annotation's hover.
